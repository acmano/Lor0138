  ...
  public class Classe
  {
    ...
    public class Variaveis
    {
      ...
      public Variaveis(DataRow dataRow)
      {
        ...
        #region Linha1
        CodigoClassificacaoFiscal = DbConvert.GetString ( dataRow, nameof( CodigoClassificacaoFiscal ) );
        CodigoIncidenciaIcms = DbConvert.GetString ( dataRow, nameof( CodigoIncidenciaIcms ) );
        CodigoIncidenciaIpi = DbConvert.GetString ( dataRow, nameof( CodigoIncidenciaIpi ) );
        AliquotaIpi = DbConvert.GetDouble(dataRow, "AliquoptaIpi");
        #endregion

        #region Linha2
        CodigoContenedor = DbConvert.GetString ( dataRow, nameof( CodigoContenedor ) );
        DescricaoContenedor = DbConvert.GetString ( dataRow, nameof( DescricaoContenedor ) );
        QuantidadeItensContenedor = DbConvert.GetInt32 ( dataRow, nameof( QuantidadeItensContenedor ) );
        QuantidadeEmpilhamentoMaximo = DbConvert.GetInt32 ( dataRow, nameof( QuantidadeEmpilhamentoMaximo ) );
        CodigoPainel = DbConvert.GetString ( dataRow, nameof( CodigoPainel ) );
        CodigoPainelFisico = DbConvert.GetString ( dataRow, nameof( CodigoPainelFisico ) );
        #endregion
        ...
        DataCadastro = DbConvert.GetDateTime ( dataRow, nameof( DataCadastro ) );
        ProdutoChave = DbConvert.GetString ( dataRow, nameof( ProdutoChave ) );
        #endregion
        ...
        #region Linha5
        Estoque = DbConvert.GetBoolean ( dataRow, nameof( Estoque ) );
        ...
        CodigoLocalProducao = DbConvert.GetString ( dataRow, nameof( CodigoLocalProducao ) );
        DescricaoLocalProducao = DbConvert.GetString ( dataRow, nameof( DescricaoLocalProducao ) );
        #endregion

        #region Linha6
        Inspecao = DbConvert.GetBoolean ( dataRow, nameof( Inspecao ) );
        ...
        IesForcaApontamento = DbConvert.GetBoolean ( dataRow, nameof( IesForcaApontamento ) );
        IesSofreBaixa = DbConvert.GetBoolean ( dataRow, nameof( IesSofreBaixa ) );
        IesAberturaLiberacao = DbConvert.GetString ( dataRow, nameof( IesAberturaLiberacao ) );
        IesPlanejamento = DbConvert.GetString ( dataRow, nameof( IesPlanejamento ) );
        #endregion

        #region Linha7
        QuantidadeEstoqueSeguranca = DbConvert.GetDouble ( dataRow, nameof( QuantidadeEstoqueSeguranca ) );
        QuantidadeDiasEstoqueSeguranca = DbConvert.GetInt32 ( dataRow, nameof( QuantidadeDiasEstoqueSeguranca ) );
        QuantidadeDiasRessuprimento = DbConvert.GetInt32 ( dataRow, nameof( QuantidadeDiasRessuprimento ) );
        CodigoProgramador = DbConvert.GetString ( dataRow, nameof( CodigoProgramador ) );
        NomeProgramador = DbConvert.GetString ( dataRow, nameof( NomeProgramador ) );
        #endregion

        #region Linha8
        QuantidadeProgramacaoMinima = DbConvert.GetDouble ( dataRow, nameof( QuantidadeProgramacaoMinima ) );
        QuantidadeProgramacaoMaxima = DbConvert.GetDouble ( dataRow, nameof( QuantidadeProgramacaoMaxima ) );
        CodigoComprador = DbConvert.GetString ( dataRow, nameof( CodigoComprador ) );
        NomeComprador = DbConvert.GetString ( dataRow, nameof( NomeComprador ) );
        #endregion

        #region Linha9
        QuantidadeProgramacaoMultipla = DbConvert.GetDouble ( dataRow, nameof( QuantidadeProgramacaoMultipla ) );
        QuantidadeProgramacaoFixa = DbConvert.GetDouble ( dataRow, nameof( QuantidadeProgramacaoFixa ) );
        #endregion
      ...
      public Variaveis ( SqlDataReader dataReader = null )
      {
        ...
        {
          #region Linha1
          CodigoClassificacaoFiscal = DbConvert.GetString ( dataReader, nameof( CodigoClassificacaoFiscal ) );
          CodigoIncidenciaIcms = DbConvert.GetString ( dataReader, nameof( CodigoIncidenciaIcms ) );
          CodigoIncidenciaIpi = DbConvert.GetString ( dataReader, nameof( CodigoIncidenciaIpi ) );
          AliquotaIpi = DbConvert.GetDouble(dataReader, nameof( AliquotaIpi ) );
          #endregion

          #region Linha2
          CodigoContenedor = DbConvert.GetString ( dataReader, nameof( CodigoContenedor ) );
          DescricaoContenedor = DbConvert.GetString ( dataReader, nameof( DescricaoContenedor ) );
          QuantidadeItensContenedor = DbConvert.GetInt32 ( dataReader, nameof( QuantidadeItensContenedor ) );
          QuantidadeEmpilhamentoMaximo = DbConvert.GetInt32 ( dataReader, nameof( QuantidadeEmpilhamentoMaximo ) );
          CodigoPainel = DbConvert.GetString ( dataReader, nameof( CodigoPainel ) );
          CodigoPainelFisico = DbConvert.GetString ( dataReader, nameof( CodigoPainelFisico ) );
          #endregion
          ...
          DataCadastro = DbConvert.GetDateTime ( dataReader, nameof( DataCadastro ) );
          ProdutoChave = DbConvert.GetString ( dataReader, nameof( ProdutoChave ) );
          #endregion
          ...
          #region Linha5
          Estoque = DbConvert.GetBoolean ( dataReader, nameof( Estoque ) );
          ...
          CodigoLocalProducao = DbConvert.GetString ( dataReader, nameof( CodigoLocalProducao ) );
          DescricaoLocalProducao = DbConvert.GetString ( dataReader, nameof( DescricaoLocalProducao ) );
          #endregion

          #region Linha6
          Inspecao = DbConvert.GetBoolean ( dataReader, nameof( Inspecao ) );
          ...
          IesForcaApontamento = DbConvert.GetBoolean ( dataReader, nameof( IesForcaApontamento ) );
          IesSofreBaixa = DbConvert.GetBoolean ( dataReader, nameof( IesSofreBaixa ) );
          IesAberturaLiberacao = DbConvert.GetString ( dataReader, nameof( IesAberturaLiberacao ) );
          IesPlanejamento = DbConvert.GetString ( dataReader, nameof( IesPlanejamento ) );
          #endregion

          #region Linha7
          QuantidadeEstoqueSeguranca = DbConvert.GetDouble ( dataReader, nameof( QuantidadeEstoqueSeguranca ) );
          QuantidadeDiasEstoqueSeguranca = DbConvert.GetInt32 ( dataReader, nameof( QuantidadeDiasEstoqueSeguranca ) );
          QuantidadeDiasRessuprimento = DbConvert.GetInt32 ( dataReader, nameof( QuantidadeDiasRessuprimento ) );
          CodigoProgramador = DbConvert.GetString ( dataReader, nameof( CodigoProgramador ) );
          NomeProgramador = DbConvert.GetString ( dataReader, nameof( NomeProgramador ) );
          #endregion

          #region Linha8
          QuantidadeProgramacaoMinima = DbConvert.GetDouble ( dataReader, nameof( QuantidadeProgramacaoMinima ) );
          QuantidadeProgramacaoMaxima = DbConvert.GetDouble ( dataReader, nameof( QuantidadeProgramacaoMaxima ) );
          CodigoComprador = DbConvert.GetString ( dataReader, nameof( CodigoComprador ) );
          NomeComprador = DbConvert.GetString ( dataReader, nameof( NomeComprador ) );
          #endregion

          #region Linha9
          QuantidadeProgramacaoMultipla = DbConvert.GetDouble ( dataReader, nameof( QuantidadeProgramacaoMultipla ) );
          QuantidadeProgramacaoFixa = DbConvert.GetDouble ( dataReader, nameof( QuantidadeProgramacaoFixa ) );
          #endregion
    ...
    private void PopulaRecord(Item.Classe item)
    {
      ...
      query.AppendFormat ( Sql.QueryItem, _acessoSql.OpenQuery, item.Campos.Variaveis.CodigoEmpresa, item.Campos.Variaveis.CodigoItem );
